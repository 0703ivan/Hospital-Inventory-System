...
<div class="body-section">
      ...
      <div class="aside-right">
        ...
        <form action="manage-patients.php" method="POST">
          <input type="submit" class="btn btn-info" name="add" value="Add Patient">
          <input type="submit" class="btn btn-info" name="info" value="Update Info">
          <input type="submit" class="btn btn-info" name="view" value="View Info">
          <input type="submit" class="btn btn-info" name="print" value="Print">
          <input type="submit" class="btn btn-info" name="remove" value="Remove">
        </form>
        <?php
          if(isset($_POST['add'])){
            require('../reg-php/p-regform.php');
          }
          if(isset($_POST['info'])){
            require('../u-php/p-regform.php');
          }
          if(isset($_POST['remove'])){
            require('../d-php/p-regform.php');
          }
        ?>
        <table class="table table-striped table-hover "align="center" cellpadding="10" border="1" cellspacing="0" width="900px">
          ...
          <?php 
            require('../connect.php');
            $sql=mysqli_query($con,"SELECT * FROM `patient`") or die("failed to connect");
