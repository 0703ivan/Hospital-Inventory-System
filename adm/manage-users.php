...
<div class="body-section">
      ...
      <div class="aside-right">
        ...
        <form action="manage-users.php" method="POST">
          <input type="submit" class="btn btn-info" name="add" value="Add User">
          <input type="submit" class="btn btn-info" name="info" value="Update Info">
          <input type="submit" class="btn btn-info" name="remove" value="Remove User">
        </form>
        <?php
          if(isset($_POST['add'])){
            require('../reg-php/u-regform.php');
          }
          if(isset($_POST['info'])){
            require('../u-php/u-regform.php');
          }
          if(isset($_POST['remove'])){
            require('../d-php/u-regform.php');
          }
        ?>
        <table class="table table-striped table-hover "align="center" cellpadding="10" border="1" cellspacing="0" width="900px">
          <thead>
            ...
            <th class="info">PREVILAGE</th>
          </thead>
          <?php 
            require('../connect.php');
            $sql=mysqli_query($con,"SELECT * FROM `login`") or die("failed to connect");
