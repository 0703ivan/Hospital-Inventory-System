  ...
  <body>
    <div class="container">
      <nav class="navbar navbar-default">
        ...
        <li id="pop" ><a href="#" onClick="MyWindow=window.open('notification.php','MyWindow',width=600,height=300); return false;">Notification </a></li>
        <li class="dropdown">
...
<div class="body-section">
      <div class="aside-left">
        ...
        <ul class="list-group hover">
          <li class="list-group-item"><a href="adm/staff.php">STAFF</a></li>
          <li class="list-group-item"><a href="adm/manage-staff.php">MANAGE STAFF</a></li>
          <li class="list-group-item"><a href="adm/patients.php">PATIENTS</a></li>
          <li class="list-group-item"><a href="adm/manage-patients.php">MANAGE PATIENTS</a></li>
          <li class="list-group-item"><a href="adm/supply.php">SUPPLY</a></li>
          <li class="list-group-item"><a href="adm/manage-supply.php">MANAGE SUPPLY</a></li>
      </ul>
