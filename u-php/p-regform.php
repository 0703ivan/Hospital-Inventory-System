<form method="post" action="../u-php/p-registration.php" >
		<table align="center" style="font-weight: bold; font-size: 20px;">
			<tr class="form-group has-success">
				<td><input required="required" class="form-control" id="inputSuccess" type="text" name="patient_id" placeholder="Patient ID" size="40" ></td>
			...
			<tr class="form-group has-success">
				<td><input required="required" class="form-control" id="inputSuccess" type="text" name="course" placeholder="Course" size="40" ></td>
				<td><input class="btn btn-info btn-sm" type="submit" name="patient" value="Update Patient" ></td>
			</tr>
		</table>
	</form>